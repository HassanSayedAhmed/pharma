...
@section('body')
<!-- Single product view -->
<div class="entry event " style="margin:0px">
								<div class=" row align-items-center"  style='background-color:white'>
									...
									<div class="row col-md-4">
										<div class="col-12 entry-title title-xs">
											<p class="text-center row" ><span class="col-3" style="text-transform:capitalize;">الإسم</span>   <a href="#" class="col-9">Acivirax 400mg Tablet</a></p>
										</div>
										<div class="col-12 entry-title title-xs">
								...
								<div class="grid-inner row align-items-center g-0 p-4">
									...
									<div class="col-md-12">
										...
										<div class="entry-content">
											<a href="#" class="btn btn-infoss btn-sm unique-btn">المزيد</a> <a href="#" class="btn btn-dangerss btn-sm unique-btn2">واتساب</a>
										</div>
									</div>
								</div>
							</div>
							<div class="entry event mb-3 col-lg-6">
								<div class="grid-inner row align-items-center g-0 p-4">
									...
									<div class="col-md-12 ">
										...
										<div class="entry-content">
											<a href="#" class="btn btn-infoss btn-sm">المزيد</a> <a href="#" class="btn btn-dangerss btn-sm">واتساب</a>
										</div>
									</div>
								</div>
							</div>
