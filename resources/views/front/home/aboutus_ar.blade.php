	...
	<!-- Top Bar
		...
		<section id="page-title" class="page-title-parallax page-title-dark include-header" style="padding: 250px 0; background-image: url('{{asset('front/images/about/parallax.jpg')}}'); background-size: cover; background-position: center center;" data-bottom-top="background-position:0px 400px;" data-top-bottom="background-position:0px -500px;">
			...
			<div class="container clearfix">
				...
				<span>
					المعمل الدوائي هو الأفضل في الشرق الأوسط.
				</span>
			</div>
				...
				<div class="container clearfix">
					...
					<div class="row col-mb-50 mb-0">
						...
						<div class="col-lg-4">
							...
							<p>
							نحن واحدة من أسرع شركات الأدوية نموًا في منطقة الشرق الأوسط وشمال إفريقيا وفقًا لتقارير IQVIA.
مكان مثالي للتطوير الوظيفي وفرص النمو مع أكثر من 100 منتج في السوق و 150 منتجًا آخر في خطوط الأنابيب التي تغطي جميع الفئات العلاجية.
							</p>
						...
						<div class="col-lg-4">
							...
							<p>
							نحن نسعى جاهدين لمقارنة المنافسين في إرضاء عملائنا. <br>
لتزويد المتخصصين في الرعاية الصحية بأدوية عالية الجودة وبأسعار معقولة. <br>
علاوة على ذلك ، نحن ملتزمون بسد معظم الثغرات العلاجية في السوق.
							</p>
						...
						<div class="col-lg-4">
							...
							<p>
							سنعزز مكانتنا كشركة رائدة في مجال الأدوية والتكنولوجيا الفائقة ليس فقط في السوق المصري ولكن أيضًا في المنطقة لتزويد السوق بـ "علاج لكل مرض" ولأن نصبح واحدة من أفضل 10 شركات أدوية رائدة بحلول عام 2021.
							</p>
					...
					<div class="col-md-7 col-padding">
						<div>
							...
							<div class="row col-mb-50">
								...
								<div class="col-lg-6">
									<p>
									بالأمس ، استندت استراتيجيتنا إلى ملء الفجوات العلاجية في السوق المصري ، لكن اليوم ، تركز استراتيجية المعمل الدوائي على ملء الفجوات العلاجية التي تتمتع بجاذبية وإمكانيات سوقية حقيقية.
									</p>
									<p>
									على الصعيدين الوطني والدولي ، نعمل على مساعدة المجتمع ومساعدة المرضى على العيش بصحة جيدة من خلال الأبحاث والعلاجات المبتكرة.
									</p>
								</div>
					...
					<div class="col-md-7 col-padding" style="background-color: #F5F5F5;">
						<div>
							...
							<div class="row col-mb-50">
								...
								<div class="col-lg-6">
									<p >
									التركيز على الجودة والحداثة وشغفنا بوضع المريض أولاً هي أهم ركائز فلسفتنا. <br>
									توفير بيئة عمل آمنة وصعبة لعائلة المعمل الدوائي. <BR>
									رد الجميل للمجتمع من خلال البدء في مبادرات خيرية تحدث تغييرًا إيجابيًا ملحوظًا.
									</p>
								</div>
					...
					<div class="row col-mb-50">
						<div class="col-lg-6">
							...
							<div class="widget clearfix">
								...
								<h2> المعمل الدوائي </h2>

								<p style="font-weight: bold;">كن ضيفنا</p>
